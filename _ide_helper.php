...
namespace Scriptoshi\McpClient\Facades {
    ...
    class McpClient {
         ...
         * @static 
         */
        public static function processRequest($userMessage, $chatUuid = null)
        {
            /** @var \Scriptoshi\McpClient\McpClient $instance */
            return $instance->processRequest($userMessage, $chatUuid);
        }
         ...
         * @static 
         */
        public static function processClaudeResponse($message)
        {
            /** @var \Scriptoshi\McpClient\McpClient $instance */
            return $instance->processClaudeResponse($message);
        }
         ...
         * @static 
         */
        public static function executeTool($runner)
        {
            /** @var \Scriptoshi\McpClient\McpClient $instance */
            return $instance->executeTool($runner);
        }
...
namespace  {
    ...
    class McpClient extends \Scriptoshi\McpClient\Facades\McpClient {}
}
